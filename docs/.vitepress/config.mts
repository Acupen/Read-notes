...
import sideBarGuide from '../utils/sidebarGuide';
...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      {
        text: '常用方法',
        link: '/common-method/type',
      },
    ],
    sidebar: {
      '/render/': {
        base: '/render/',
        items: sideBarGuide('render'),
      },
      '/algorithm/Sort/': {
        base: '/algorithm/Sort/',
        items: sideBarGuide('algorithm'),
      },
      '/common-method/': {
        base: '/common-method/',
        items: sideBarGuide('common-method'),
      },
      '/': {
        base: '/',
        items: sideBarGuide('examples'),
      },
    },
    socialLinks: [
    ...
    footer: {
      message: '基于 MIT 许可发布',
      copyright: `版权所有 © 2019-${new Date().getFullYear()} noctis`,
    },
